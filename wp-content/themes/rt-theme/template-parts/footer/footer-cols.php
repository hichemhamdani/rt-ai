<div class="rt-footer-cols">
    <div class="rt-container">
        <div class="rt-footer-cols__grid">

            <!-- Col 1 — Company -->
            <div class="rt-footer-col rt-footer-col--company">
                <h4 class="rt-footer-col__title">Rutherford &amp; Titan</h4>
                <p class="rt-footer-col__desc">
        ...
        <div class="rt-footer-bottom">
            <p class="rt-footer-bottom__copy">
                Rutherford Titan &mdash; All rights reserved &copy; <?php echo date('Y'); ?>
            </p>
            <nav class="rt-footer-legal" aria-label="Liens légaux">
                <a href="<?php echo esc_url( get_permalink(15) ); ?>">Terms &amp; Conditions</a>
                <a href="<?php echo esc_url( get_permalink(6573) ); ?>">Return Policy</a>
                <a href="<?php echo esc_url( get_permalink(9) ); ?>">Privacy Statement</a>
            </nav>
        </div>
